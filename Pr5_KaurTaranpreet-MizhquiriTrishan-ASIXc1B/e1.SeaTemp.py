...
"""
# Datos
months = ['Gener', 'Febrer', 'Març', 'Abril', 'Maig', 'Juny', 'Juliol', 'Agost', 'Setembre', 'Octubre',
          'Novembre', 'Desembre', 'Mitjana anual']
...
def maximo(temperature_data):
    max_temperatura = temperature_data[0]
    for x in temperature_data:
        if x > max_temperatura:
            max_temperatura = x
    return max_temperatura
print(maximo(temperature_data))